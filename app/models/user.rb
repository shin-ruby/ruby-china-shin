...
class User
  ...
  has_many :photos
  has_many :send_messages, class_name: 'Message' , dependent: :destroy, inverse_of: :sender
  has_many :accept_messages,class_name: 'Message',  dependent: :destroy, inverse_of: :accepter
